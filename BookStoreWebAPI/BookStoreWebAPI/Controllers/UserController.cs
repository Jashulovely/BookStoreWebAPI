    ...
    public class UserController : ControllerBase
    {
        ...
        public IActionResult Registration(UserModel model)
        {
            ...
            else
            {
                ...
                if (result != null)
                {
                    return Ok(new ResponseModel<UserModel> { Status = true, Message = "Register Successful", Data = result });
                }
                else
                {
        ...
        {
            List<UserModel> allUsers = (List<UserModel>)userBusiness.GetAllUsers();
            if (allUsers != null)
            {
                return Ok(new ResponseModel<List<UserModel>> { Status = true, Message = "All Users", Data = allUsers });
            }
            else
            {
                return BadRequest(new ResponseModel<List<UserModel>> { Status = false, Message = "Users not exists." });
            }
        }
